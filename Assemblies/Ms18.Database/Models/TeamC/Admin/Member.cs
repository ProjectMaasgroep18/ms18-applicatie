...
namespace Ms18.Database.Models.TeamC.Admin
{
    public record Member
    {
        ...
        public ICollection<Receipt.Receipt> ReceiptsCreated { get; set; }
        public ICollection<Receipt.Receipt> ReceiptsModified { get; set; }
        public ICollection<Receipt.Receipt> ReceiptsDeleted { get; set; }
